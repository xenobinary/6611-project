...
public class LanguageSelectorPanel extends BaseViewPanel implements NumpadListener {
    ...
    public void configure(
        String preLangState,
        String preLangAction,
        Account preLangAcc,
        Account preLangDest,
        boolean preLangHistory,
        boolean preLangBalance
    ) {
    ...
    public void onShow() {
        ...
        if ("admin".equals(preLangState)) {
            bg = new Color(102, 0, 0);
            btnBg = new Color(150, 30, 30);
        } else if ("tech".equals(preLangState)) {
            bg = new Color(0, 80, 60);
            btnBg = new Color(0, 120, 80);
        }

...
public class DatabaseManager {
    ...
    private static final String DB_PATH =
        System.getProperty("user.dir") + "/ibank.db";
    ...
    private void seedData() throws SQLException {
        ...
        for (Object[] a : accounts) {
            ...
            pa.setDouble(3, (Double) a[2]);
            pa.setString(4, (String) a[3]);
        ...
        for (String[] r : rates) {
            pr.setString(1, r[0]);
            pr.setDouble(2, Double.parseDouble(r[1]));
            pr.executeUpdate();
        }
    }
    ...
    public void updateExchangeRate(String pair, double rate)
        throws SQLException {
        PreparedStatement ps = conn.prepareStatement(
    ...
    public void persistTransaction(Account account, TransactionRecord record)
        throws SQLException {
    ...
    public List<TransactionRecord> loadTransactions(String cardNumber)
        throws SQLException {
    ...
    public double getDailyTotal(String cardNumber, String type)
        throws SQLException {
        double total = 0;
        ...
        while (rs.next()) {
            TransactionRecord r = TransactionRecord.fromDbString(
                rs.getString("record")
            );
